<template>
  <details>
    <summary>
      Treatments
      (
      <spinner v-if="js.loading" /><svg v-for="n in js.treatments.def.length" :key="n + 'def'" class="green"
        viewBox="0 0 24 24">
    ...
    <div v-if="(!js.treatments.def.length && !js.loading) || js.treatments.def.length || js.treatments.aug.length">
      ...
      <ul class="nobullet">
        <li v-for="t in js.treatments.def" :key="t.url">
        ...
        <li v-for="t in js.treatments.aug" :key="t.url">
    ...
    <div v-if="js.treatments.dpr.length">
      ...
      <ul class="nobullet">
        <li v-for="t in js.treatments.dpr" :key="t.url">
...
@Component({
  components: { Spinner, CitedMaterials }
})
